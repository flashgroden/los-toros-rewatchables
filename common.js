...
function mast(){setTimeout(wireIdentity,0);return `<div class="mast"><div><a class="brand-link" href="list.html"><div class="brand">Los Toros</div><div class="sub">Rewatchables Movie Club</div></a>${identityControl()}</div><nav aria-label="Main navigation"><a href="list.html">The Board</a><a href="critics.html">Critics</a><a href="nominate.html">Nominate</a><a href="review.html">Rate a Film</a><a href="about.html">About</a><a href="how-it-works.html">How It Works</a></nav></div>`}
